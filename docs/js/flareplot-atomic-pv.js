...
function createAtomicProteinViewer(flareplot, contents, pdbFile, container, width, height, callback) {
    ...
    residue_to_atomic_contacts = getResidueToAtomContacts(contents);
    ...
    function updateInteractions() {
        console.log(residue_to_atomic_contacts)
                    ...
                    if(atomic_interactions !== undefined){
                        for (i = 0; i < atomic_interactions.length; i++){
                            ...
                            for (j = 0; j < atoms.length; j++){
                                ...
                                console.log(resid, resi1, resi2)
                                // var atom = struc.atom("A." + resid + ".CA")
    ...
    pv.io.fetchPdb(pdbFile, function (structure) {
        struc = structure;
        viewer.lines("protein", structure, {color: color.ssSuccession()});
